package simpleFrame18.core.view.perspective;
...
import simpleFrame18.core.util.ButtonTabComponent;
...
public class DefaultPerspective implements Perspective {
	...
	public void addView(ViewContainer view, PerspectiveConstraint constraint) {
		...
		logger.info("loading view:"+view.getTitle());
		logger.info("loading view:"+component.getClass().getSimpleName());
		logger.info("loading panel:"+panel.getClass().getSimpleName());
